...
class  Media {
  ...
  public function upload($file)
  {
    ...
    elseif(!$this->file_ext($file['name'])):
      ...
      $this->name = remove_junk($_POST['name']);
      $this->position =  remove_junk($_POST['position']);
      $this->id =  remove_junk($_POST['id']);
     return true;
    endif;
...
/*--------------------------------------------------------------*/
  private function insert_media(){
         ...
         global $db;
         $sql  = "INSERT INTO media ( file_name,file_type,id,name,position )";
         $sql .=" VALUES ";
         $sql .="(
