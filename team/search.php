...
<h2 class="wow fadeInUp mb-4 mt-5" data-wow-duration="1s" data-wow-delay=".4s">Search for HopeMirror Members by ID</h2>
                            
                           
                           

   <form class="" action="search_result.php" method="POST" enctype="multipart/form-data">
         
            <div class="form-group wow fadeInUp">

              
                <input type="text" class="form-control mb-3" name="searchid" placeholder="HopeMirror ID">
                <button type="submit" name="submit" class="boxed-btn3 wow fadeInUp">Search</button>
